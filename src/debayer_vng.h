 ...
 *
 *****************************************************************************/
#ifndef DEBAYER_VNG_H
#define DEBAYER_VNG_H
...
/**
 * Performs VNG (Variable Number of Gradients) debayering on 16-bit Bayer data and converts it to RGBA 16-bit output.
 * This method uses a weighted 3x3 neighborhood to interpolate color values based on the Bayer pattern.
 *
 ...
 */
int debayer_vng_rgb16(const uint16_t *raw, int width, int height, uint16_t *rgb, int x_offset, int y_offset, const char *bayer_pattern);


/**
 * Performs VNG (Variable Number of Gradients) debayering on 16-bit Bayer data and converts it to RGBA float output.
 * This method uses a weighted 3x3 neighborhood to interpolate color values based on the Bayer pattern.
 *
 * @param raw: pointer to the input Bayer image (16-bit, 1 channel per pixel).
 * @param width: image width in pixels.
